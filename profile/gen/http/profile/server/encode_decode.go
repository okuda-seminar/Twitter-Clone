...
// DecodeCreateUserRequest returns a decoder for requests sent to the profile
// CreateUser endpoint.
...
// DecodeDeleteUserRequest returns a decoder for requests sent to the profile
// DeleteUser endpoint.

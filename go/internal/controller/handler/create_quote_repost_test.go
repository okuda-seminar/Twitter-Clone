...
func TestCreateQuoteRepost(t *testing.T) {
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			...
			CreateQuoteRepostHandler := NewCreateQuoteRepostHandler(createQuoteReposeUsecase, updateNotificationUsecase)
			...
			case entity.PostTypeQuoteRepost:
				...
				parentPostID, err = newCreateQuoteRepost(updateNotificationUsecase, createQuoteReposeUsecase, parentPostID)
				if err != nil {

...
final class HomeViewControllerTests: XCTestCase {
  ...
  override func setUpWithError() throws {
    ...
    sut = HomeViewController(
      timelineService: injectFakeTimelineService(), postsDataSource: fakeTimelinePostsDataSource)
  }
  ...
  func testViewDidAppearWhenReceivedTimelineAccessedEventType() {
    ...
    injectFakeTimelineService().configureFakeTimelineService(
  ...
  func testViewDidAppearWhenReceivedPostDeletedEventType() {
    let responsePostsData: [PostModel] = [createFakePostModel()]
    fakeTimelinePostsDataSource.followingTabPostModels = responsePostsData

    injectFakeTimelineService().configureFakeTimelineService(
      simulationType: .postDeleted, responsePostsData: responsePostsData)
